...
export default function NewCategorie_depensePage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetchApi('/CategorieDepense', {
                method: 'POST',
                body: formData,
            });
    ...
    return (
        <>
            <div className="px-4 py-3 main_content bg-white has_footer">
                ...
                <div className="">
                    <h1 className="mb-3">
                        <FormattedMessage id="new-Categorie-depense"/>
                        </h1>
                    <hr className="w-100" />
                </div>
                        ...
                        <div className="form-group col-sm">
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <div>
                                        <label htmlFor="DESC_CATEGORIE_DEPENSE" 
